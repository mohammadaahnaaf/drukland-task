  ...
  return (
    <div className="min-h-screen bg-gray-100 text-[#292929] grid content-between">
      ...
      <header className="bg-white border-b">
        <div className="bg-[#DDDDDD] border-b text-sm">
          <div className="max-w-[1320px] w-full mx-auto flex justify-end gap-4 py-2">
            <Link href="/faq" className="flex items-center gap-1 text-muted-foreground hover:text-primary">
              <HelpCircle className="h-4 w-4" />
              FAQ
            </Link>
            <Link href="/inquiry" className="flex items-center gap-1 text-muted-foreground hover:text-primary">
              <Mail className="h-4 w-4" />
              Send Inquiry
            </Link>
            <Link href="/support" className="flex items-center gap-1 text-muted-foreground hover:text-primary">
              <MessageCircle className="h-4 w-4" />
              Live Support
            </Link>
            <Link href="/contact" className="flex items-center gap-1 text-muted-foreground hover:text-primary">
